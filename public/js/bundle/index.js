...
})({"7U1fV":[function(require,module,exports) {
...
const submitForm = async (title, author, description, image)=>{
    try {
        ...
        if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "Data successfully created");
            window.setTimeout(()=>{
        ...
        (0, _alert.showAlert)("error", err.response);
    }
};
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["7U1fV","f2QDv"], "f2QDv", "parcelRequire12f6")
